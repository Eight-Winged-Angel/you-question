...
import cn.edu.cupk.learn.config.MessageConfig;
...
public class SmsManager {
    ...
    public void codeSend(@NotNull String phone) throws ServiceException {
        ...
        if (expire != null && expire >= 540) {
            // 返回需等待秒数
            throw new ServiceException(ServiceCode.VERIFY_TOO_FAST_PHONE, expire - 540);
        }
    ...
    public void checkTimes(String phone) throws ServiceException {
        ...
        if (times != null && times == 0) {
            ...
            if (expire != null && expire > 0) {
                throw new ServiceException(ServiceCode.VERIFY_MISMATCH_TOO_MANY, expire);
            }
    ...
    private void apiSend(String phone, String code) throws ServiceException {
        try {
            ...
            throw new ServiceException(ServiceCode.API_SMS_ERROR);
        }
    }
